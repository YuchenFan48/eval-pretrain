...
# 在这里添加你想评测的模型路径列表
MODELS=(
    "/mnt/cephfs/users/yuchenfan/qwen-kda-fixed-data-aug-checked/iter_0258047-hf"
    "/mnt/cephfs/users/yuchenfan/qwen-kda-fixed-data-aug-checked/iter_0249855-hf"
    "/mnt/cephfs/users/yuchenfan/qwen-kda-fixed-data-aug-checked/iter_0241663-hf"
...
REASONING_TASKS="simpleqa math gsm8k mmlu-pro mmlu arc-c arc-e nq drop"
